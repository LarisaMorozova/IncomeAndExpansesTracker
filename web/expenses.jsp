<%-- 
    Document   : expenses
    Created on : Oct 25, 2016, 5:33:01 PM
...
<html>
	<head>
        ...
        <%
        session.setAttribute("currentpage", "expenses.jsp");
    %>
		...
		<div class="jumbotron">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
				<h1>Expenses</h1>
				<p>Keep track on your expenses</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="learn-more">
			  <div class="container">
				<div class="row">
			  	  <div class="col-md-10">
					<h3>Expenses</h3>
                                        <form method="post" action="addexpanses.jsp">
	                    		  ...
	                    		  <input type="text" name="description" class="form-control" placeholder="Description">
                                    ...
                                    <div class="input-group">
                                        <select name="category" class="form-control">
                                            ...
                                            <option value="trael">Travel</option>
