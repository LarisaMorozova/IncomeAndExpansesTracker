<%-- 
    Document   : reports
    Created on : Oct 25, 2016, 5:33:58 PM
...
<html>
    ...
    <%
        session.setAttribute("currentpage", "reports.jsp");
    %>
        ...
        <div class="learn-more">
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <h3>Calendar</h3>
                        <p>Choose date from to</p>
                        <form method="post" action="showreport.jsp">
                                ...
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <select name="category" class="form-control">
                                            ...
                                            <option value="allmoney">All money report</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
